...
const BookingForm = React.memo<BookingFormProps>(
  ({ item, type, basePrice, personPrice, memberPriceDiscount }) => {
                        ...
                        <AnimatePresence mode="popLayout">
                          ...
                          {!bookingAvailability && !isCheckingAvailability && (
                            ...
                            >
                              <TriangleAlertIcon className="text-red-500" />
                              <span className="text-red-500">
                                Gjenstanden kan ikke bookes i dette tidsrommet,
                                da den allerede er booket av noen andre.
                              </span>
                            </SlideAnimation>
                          )}
                        </AnimatePresence>
